 ...
 */
public class LzoRawB64LineRecordReader extends LzoRecordReader<LongWritable, BytesWritable> {
  ...
  public void initialize(InputSplit genericSplit, TaskAttemptContext context)
    ...
    String group = "LzoB64Lines of BytesWritable";
  ...
  public boolean nextKeyValue() throws IOException, InterruptedException {
    ...
    while (pos_ <= end_) {
      ...
      try {
        ...
        protoValue = new BytesWritable(base64_.decode(lineBytes));
      } catch (Throwable t) {
        decodeException = t;
      }
